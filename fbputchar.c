...
/*
*  Converts raw keycode data from the keyboard into a readable ASCII character
*
*/
// char key_input(const char *keycode_str) {
//   // these are lookup tables for lowercase and uppercase mappings
...
//   // Check if Shift is being pressed; is shift pressed on 2 ??????
//   // we have to demonstrate the special keys by typing each of them
//   int is_shift_active = (keycode_str[0] == '2' || keycode_str[1] == '2') ? 1 : 0;
//   printf("SHIFT PRESSED");

//   // Extract keycode value
//   int key_index = 0;
//   sscanf(&keycode_str[3], "%2x", &key_index);  // Convert hex keycode to integer

//   // Ensure key_index is within valid range
//   if (key_index < 0 || key_index >= sizeof(lowercase_map)) {
//       return '\0'; // Invalid keycode
//   }

//   // Return the correct mapped character based on shift state
//   return is_shift_active ? uppercase_map[key_index] : lowercase_map[key_index];

// }

/*
* Other way to encode each key manually
*/
...
/*
* clears the framebuffer when program starts
*/
void clear(void){
  int row, col;
...
static unsigned char font[] = {
  ...
  0x00, 0x00, 0x1e, 0x0c, 0x0c, 0x0c, 0x0cc, 0xcc, 0xcc, 0xcc, 0x78, 0x00, 0x00, 0x00, 0x00,
  ...
  0x00, 0x00, 0x10, 0x30, 0xfc, 0x30, 0x30, 0x30, 0x30, 0x36, 0x1c, 0x00, 0x00, 0x00, 0x00,
